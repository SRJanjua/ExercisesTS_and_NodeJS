...
//5. Test whether an item is in a array 
 ...
 var item: string = "banana";

 console.log("Is the item in the array?");
 console.log(fruits.indexOf(item) !== -1);        // true
 //console.log(fruits.includes(item));           // true // The include() function not executing in node.js
...
//6. Test whether an item is not in a array 
 ...
 var fruits: string[] = ["apple", "banana", "orange"];
 var item: string = "grape";

 console.log("Is the item not in the array?");
 console.log(fruits.indexOf(item) !== -1);        // false
 // console.log(!fruits.includes(item));         // false // The include() function not executing in node.js
